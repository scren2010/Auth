...
class Profile(models.Model):
    ...
    avatar = models.ImageField('Загрузить свою картинку', upload_to='user_profile/', null=True, blank=True)
    customer_categories = models.ForeignKey(CustomerCategories, verbose_name='Категория пользователя', blank=True,
                                            null=True,
